...
<body>
    ...
    <form class="form-register" method="post" onsubmit="">
        ...
        <div class="form-register-with-email">
            ...
            <div class="form-row">
                ...
                <input type="submit" name="btn_dsearch" value="Search">
    ...
    <tr><th>Name</th><th>Gender</th><th>Email</th><th>Phone</th><th>Blood Group</th></tr>
    ...
    try
    {
        ...
        if(request.getParameter("btn_dsearch")!=null) //check login button click event not null
        {
            String dbcity,dbgender,dbname,dbemail,dbphone,dbbgrp;
            
            String bgrp,city,willingness;
            
            bgrp=request.getParameter("txt_bgrp"); //txt_bgrp
            city=request.getParameter("txt_city"); //txt_city
            willingness="YES"; //txt_yes
            
            PreparedStatement pstmt=null; //create statement
            
            pstmt=con.prepareStatement("select * from ulogin,willingness where City=? AND Bgrp=? AND Willingness=? AND ulogin.Username=willingness.Username"); //sql select query 
            pstmt.setString(1,city);
            pstmt.setString(2,bgrp);
            pstmt.setString(3,willingness);
            
            ResultSet rs=pstmt.executeQuery(); //execute query and store in resultset object rs.
            
            //out.println("<table>");  
            //out.println("<tr><th>Name</th><th>Gender</th><th>Email</th><th>Phone</th><th>Blood Group</th></tr>");
            ...
            if(rs.next())
            {
                ...
                dbbgrp=rs.getString("Bgrp");       //request.getParameter("txt_bgrp")
                    ...
                    out.println("<tr><td>" + dbname + "</td><td>" + dbgender + "</td><td>" + dbemail + "</td><td>" + dbphone + "</td><td>" + dbbgrp + "</td></tr>");
