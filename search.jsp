...
<body>
    ...
    <form class="form-register" method="post" onsubmit="">
        ...
        <div class="form-register-with-email">
            ...
            <a href="home.html" class="form-log-in-with-existing">Back to HOME <b> Click here </b></a>  
    ...
    <tr><th>Blood Bank Id</th><th>Blood Bank Name</th><th>Address</th><th>Email</th><th>Phone</th><th>Availability</th></tr>
    ...
    try
    {
        ...
        if(request.getParameter("btn_search")!=null) //check login button click event not null
        {
            String dbcity,dbtype,dbbbname,dbaddress,dbemail,dbphone,dbid;
            int dbbgrp;
            
            String bgrp,city,type;
            
            bgrp=request.getParameter("txt_bgrp"); //txt_bgrp
            city=request.getParameter("txt_city"); //txt_city
            type=request.getParameter("txt_type"); //txt_type
            
            PreparedStatement pstmt=null; //create statement
            
            pstmt=con.prepareStatement("select * from bblogin,availability where City=? AND Type=? AND bblogin.Username=availability.Username"); //sql select query 
            ...
            while(rs.next())
            {
                ...
                dbbgrp=rs.getInt(bgrp);       //request.getParameter("txt_bgrp")
    
                
                    
                    out.println("<tr><td>" + dbid + "</td><td>" + dbbbname + "</td><td>" + dbaddress + "</td><td>" + dbemail + "</td><td>" + dbphone + "</td><td>" + dbbgrp + "</td></tr>");
                    
                    
                    
                    request.setAttribute("update",bgrp); //session name is login and store fetchable database email address
